...
box_bottom(depth=30, outer_height=25, inner_height=21, div_locs=[0, 10, 20], name_text="prosperity");


translate([93+3+3, 0, 15 + 3 + 25+ 1 + 3 + 5+.5])
rotate([180,0,180])
//translate([100, 0, 0])
box_lid(height=20, bot_depth=30, bot_outer_height=25, bot_inner_height=21, name_text="test_text", stem_plug_taper=0.4);
