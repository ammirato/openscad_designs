...
default_div_extra_width=3.0;
default_div_tol=0.7;
default_div_tol_thickness=1.0;
default_div_z_indent=0.0;
default_extra_bottom_thickness=0.0; 
...
{ 
    ...
    div_height = outer_height+ div_z_indent + extra_bottom_thickness +eps;
